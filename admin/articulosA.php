	...
	<body>
		...
		<div class="container">
			<div class="opciones">
				<div class="nav1">
					<form method="post">
						<input type="button" name="ingresar" value="Nuevo Artículo" class="btn btn-secundary ingresar" id="nuevo">
					</form>
					<form method="post">
        ...
        <script src="../js/mostrarA_A.js"></script>
        <script src="../js/formulariosA_A.js"></script>
